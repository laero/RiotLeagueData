...
(function () {
	...
	RiotData.getStaticChampionById = function(queryParams, id, callback) {
		var	options;
	...
	RiotData.getStaticItemById = function(queryParams, id, callback) {
		var	options;
		if (arguments.length === 2 && typeof id === 'function') {
			queryParams = {};
			id = arguments[0];
	...
	RiotData.getStaticMasteryById = function(queryParams, id, callback) {
		var	options;
		if (arguments.length === 2 && typeof id === 'function') {
			queryParams = {};
			id = arguments[0];
	...
	RiotData.getStaticRuneById = function(queryParams, id, callback) {
		var	options;
		if (arguments.length === 2 && typeof id === 'function') {
			queryParams = {};
			id = arguments[0];
	...
	RiotData.getStaticSummonerSpellById = function(queryParams, id, callback) {
		var	options;
		if (arguments.length === 2 && typeof id === 'function') {
			queryParams = {};
			id = arguments[0];
	 ...
	 */
	 ...
	 RiotData.getMatchById = function(id, includeTimeline, callback) {
		...
		options = buildEndpoint(Endpoints.match + '/' + id + '?' + 'includeTimeline=' + '&');
		requestData(options, callback);
	};
